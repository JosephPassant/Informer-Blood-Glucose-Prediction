# **Blood Glucose Prediction with JPFormer**
...
## Inference Dashboard (IT ARTEFACT)
...
For example to run the inference framework for patient 540 minimising error within the hypoglycaemic region run the following command:
